        ...
        <div className="w-4/5 h-full">
            <div className="text-content h-full flex flex-col">
                <div className="flex flex-col gap-y-1 py-4">
                    <header className="text-primary font-semibold text-4xl">{module.code}</header>
                ...
                <div className="rounded-lg my-5">
                    ...
                    <p className="font-bold mt-4">Workload - {module.hours} hrs / Week</p>
                </div>
                ...
                <div className="my-5">
                    ...
                    <div className="flex flex-col gap-y-2">
                        <Remark42 host="http://127.0.0.1:8080" siteId="remark" theme={remarkTheme} components={["embed"]} noFooter={true} />
                    </div>
